const species = [
  {
    ...
    photo: 'https://en.wikipedia.org/wiki/Drosophila_melanogaster#/media/File:Drosophila_melanogaster_-_side_(aka).jpg',
    kingdom: 'Animalia',
    phylum: 'Arthropoda',
    class: 'Insecta',
    order: 'Diptera',
  ...
  },
  {
    ...
    photo: 'https://en.wikipedia.org/wiki/Human#/media/File:Akha_cropped_hires.JPG',
    kingdom: 'Animalia',
    phylum: 'Chordata',
    class: 'Mammalia',
    order: 'Primates',
  ...
  },
  {
    ...
    photo: 'https://en.wikipedia.org/wiki/Pea#/media/File:Peas_in_pods_-_Studio.jpg',
    kingdom: 'Plantae',
    phylum: 'Tracheophyta',
    class: 'Magnoliopsida',
    order: 'Fabales',
  ...
  },
  {
    ...
    photo: 'https://en.wikipedia.org/wiki/Amanita_muscaria#/media/File:2006-10-25_Amanita_muscaria_crop.jpg',
    kingdom: 'Fungi',
  ...
  },
  {
    ...
    photo: 'https://en.wikipedia.org/wiki/Escherichia_coli#/media/File:EscherichiaColi_NIAID.jpg',
    kingdom: 'Eubacteria',
